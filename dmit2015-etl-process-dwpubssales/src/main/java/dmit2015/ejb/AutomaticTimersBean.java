...
public class AutomaticTimersBean {	// Also known as Calendar-Based Timers
	...
	private final Logger logger = Logger.getLogger(AutomaticTimersBean.class.getName());
	...
	@Schedule(second = "0", minute ="42,45,47", hour = "11",
			dayOfWeek = "Mon,Tue,Thu",
			month = "Jan-Apr",
			year = "2026",
			info ="DMIT2015-A01 Online Meeting", persistent = false)
